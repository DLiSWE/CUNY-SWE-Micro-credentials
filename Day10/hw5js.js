...
const convertToFarenHeight = (celsius) => {
...
const convertToCelsius = (fahrenheit) => {
    ...
    return `${fahrenheit1}°F equals ${celsius}°C`;
}

console.log(convertToFarenHeight(celsius1));
console.log(convertToCelsius(fahrenheit1));
